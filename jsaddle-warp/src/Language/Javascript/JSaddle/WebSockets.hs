...
jsaddleOrWithIndex :: ByteString -> ConnectionOptions -> JSM () -> Application -> IO Application
jsaddleOrWithIndex idx opts entryPoint otherApp = do
...
jsaddleOr = jsaddleOrWithIndex indexHtml
